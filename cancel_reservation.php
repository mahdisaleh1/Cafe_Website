...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE reservations SET status='cancelled' WHERE phone='$phone' AND reservation_date='$date' AND guest_count='$number'";
    if (mysqli_query($con, $sql)) {
        echo "<script>alert('Reservation cancelled successfully!');</script>";
    } else {
        echo "<script>alert('Error cancelling reservation: " . mysqli_error($con) . "');</script>";
    }
}
?>
<!doctype html>
...
<head>
    ...
    <title>Barista Café - Cancel Reservation</title>
    <!-- CSS FILES -->
                        ...
                        <div class="booking-form-wrap">
                            <div class="row">
                                <div class="col-lg-7 col-12 p-0">
                                    <form class="custom-form booking-form" action="./cancel_reservation.php" method="post" role="form">
                                        <div class="text-center mb-4 pb-lg-2">
                                            <em class="text-white">Fill out the booking form</em>
                                            <h2 class="text-white">Cancel Reservation</h2>
                                        </div>
                                        <div class="booking-form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-12">
                                                    ...
                                                    <textarea name="booking-form-message" rows="3" class="form-control" id="booking-form-message"
                                                        placeholder="Any problem for cancellation? (Optional)"></textarea>
                                                </div>
